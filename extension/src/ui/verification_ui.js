...
export class ClosedVerificationUI {
    ...
    `;
        ...
        const inputElem = this.shadowRoot.querySelector("#tsif-proposed-label-input");
        const acceptBtn = this.shadowRoot.querySelector("#tsif-btn-accept");
        const rejectBtn = this.shadowRoot.querySelector("#tsif-btn-reject");
        const reportBtn = this.shadowRoot.querySelector("#tsif-btn-report");
        acceptBtn.onclick = () => {
