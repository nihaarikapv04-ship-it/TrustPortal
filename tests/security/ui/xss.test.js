...
(0, vitest_1.describe)("Security Test: Confirmation UI Safe Text Node Rendering & XSS Defense", () => {
    let panel;
    let targetBtn;
    ...
    (0, vitest_1.test)("Invariant 14: Renders malicious <script> label string safely as literal text without executing", () => {
