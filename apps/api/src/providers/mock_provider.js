export class MockTextProvider {
    ...
    async proposeLabel(context, _request) {
...
export class AdversarialMockProvider {
    id = "adversarial-mock-v1";
    capabilities = {
        text: true,
        vision: false,
        languages: ["en"],
    ...
    attackMode;
    constructor(attackMode) {
        this.attackMode = attackMode;
    }
    async proposeLabel(_context, _request) {
