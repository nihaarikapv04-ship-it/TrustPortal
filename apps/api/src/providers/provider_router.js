...
export class ModelRouter {
    ...
    constructor(textProvider, visionProvider) {
     ...
     */
    async routeAndInference(context, requestParams) {
    ...
    executeWithTimeout(provider, context, req) {
