 ...
 */
import { ALLOWLISTED_ATTRIBUTES, STRICTLY_FORBIDDEN_ATTRIBUTES, validateIssueAttributeCompatibility } from "./patch_model.js";
...
export class PatchApplicator {
     ...
     */
    validateAndSanitizeValue(rawLabel) {
        ...
        if (PROMPT_INJECTION_KEYWORDS.test(clean))
            return null;
