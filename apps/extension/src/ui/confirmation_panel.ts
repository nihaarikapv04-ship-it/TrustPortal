...
export class TrustPortalConfirmationPanel {
  ...
  private viewModel: ConfirmationViewModel | null = null;
  private actions: PanelActions | null = null;
  private statusAnnouncer: (msg: string) => void = () => {};
  ...
  public mount(targetContainer: HTMLElement = document.body): void {
  ...
  public render(viewModel: ConfirmationViewModel, actions: PanelActions, mode: "confirming" | "editing" | "applied" | "conflict" = "confirming"): void {
