...
export class PanelController {
    ...
    constructor(patchApplicator, patchLedger) {
    ...
    showProposal(viewModel, targetElement) {
    ...
    handleAccept(proposedValue, isEdited = false) {
        ...
        const patch = {
            ...
            issueType: this.currentViewModel.issue.type,
