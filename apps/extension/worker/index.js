...
// src/policy/storage.js
var PolicyStorage = class {
...
async function handleWorkerMessage(rawMessage) {
...
if (typeof chrome !== "undefined" && chrome.runtime) {
  chrome.runtime.onInstalled.addListener(() => {
    console.log("\u{1F6E1}\uFE0F TrustPortal TSIF Background Worker Installed.");
  });
  chrome.runtime.onMessage.addListener((message, _sender, sendResponse) => {
    handleWorkerMessage(message).then((response) => sendResponse(response)).catch((err) => {
      sendResponse({
        type: "ERROR_RESPONSE",
        schemaVersion: 1,
