...
exports.HardenedPatchEngine = void 0;
...
const STRICTLY_FORBIDDEN_ATTRIBUTES = new Set([
    "href",
    "onclick",
    "action",
    "innerhtml",
...
class HardenedPatchEngine {
     ...
     */
    checkAndYieldOnReclaim(element, patch) {
...
exports.HardenedPatchEngine = HardenedPatchEngine;
